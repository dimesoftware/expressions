...
namespace Dime.Utilities.Expressions.Tests
{
    ...
    public class FilterBuilderTests
    {
        ...
        [TestMethod]
        [TestCategory("Filter")]
        public void FilterBuilder_And_ArgumentNull_ThrowsArgumentNullException()
        {
            Expression<Func<Person, bool>>[] includes = null;
            ArgumentNullException ex = Assert.ThrowsException<ArgumentNullException>(() => FilterBuilder.And(includes));
            Assert.AreEqual(ex.Message, "Value cannot be null.\r\nParameter name: expressions");
        }

        [TestMethod]
        [TestCategory("Filter")]
        public void FilterBuilder_And_OneArgument_ReturnsSame()
        {
            Expression<Func<Person, bool>> f1 = (x) => x.Id > 0;
            Expression<Func<Person, bool>> mergedExpression = FilterBuilder.And(f1);
        ...
        [TestMethod]
        [TestCategory("Filter")]
        public void FilterBuilder_And_TwoArguments_Success()
        {
            Expression<Func<Person, bool>> f1 = (x) => x.Id > 0;
            Expression<Func<Person, bool>> f2 = (x) => x.Category == "CATEGORY 1";
            Expression<Func<Person, bool>> mergedExpression = FilterBuilder.And(f1, f2);
        ...
        [TestMethod]
        [TestCategory("Filter")]
        public void FilterBuilder_And_ThreeArguments_Success()
        {
            Expression<Func<Person, bool>> f1 = (x) => x.Id > 0;
            Expression<Func<Person, bool>> f2 = (x) => x.Category == "CATEGORY 1";
            Expression<Func<Person, bool>> f3 = (x) => x.Name == "Dude";
            Expression<Func<Person, bool>> mergedExpression = FilterBuilder.And(f1, f2, f3);
        ...
        [TestMethod]
        [TestCategory("Filter")]
        public void FilterBuilder_And_FourArguments_Success()
        {
            Expression<Func<Person, bool>> f1 = (x) => x.Id > 0;
            Expression<Func<Person, bool>> f2 = (x) => x.Category == "CATEGORY 1";
            Expression<Func<Person, bool>> f3 = (x) => x.Name == "Dude";
            Expression<Func<Person, bool>> f4 = (x) => x.City == "LA";
            Expression<Func<Person, bool>> mergedExpression = FilterBuilder.And(f1, f2, f3, f4);
        ...
        [TestMethod]
        [TestCategory("Filter")]
        public void FilterBuilder_And_FiveArguments_Success()
        {
            Expression<Func<Person, bool>> f1 = (x) => x.Id > 0;
            Expression<Func<Person, bool>> f2 = (x) => x.Category == "CATEGORY 1";
            Expression<Func<Person, bool>> f3 = (x) => x.Name == "Dude";
            ...
            Expression<Func<Person, bool>> mergedExpression = FilterBuilder.And(f1, f2, f3, f4, f5);
        ...
        [TestMethod]
        [TestCategory("Filter")]
        public void FilterBuilder_Or_ArgumentNull_ThrowsArgumentNullException()
        {
            Expression<Func<Person, bool>>[] includes = null;
            ArgumentNullException ex = Assert.ThrowsException<ArgumentNullException>(() => FilterBuilder.Or(includes));
            Assert.AreEqual(ex.Message, "Value cannot be null.\r\nParameter name: expressions");
        }

        [TestMethod]
        [TestCategory("Filter")]
        public void FilterBuilder_Or_OneArgument_ReturnsSame()
        {
            Expression<Func<Person, bool>> f1 = (x) => x.Id > 0;
            Expression<Func<Person, bool>> mergedExpression = FilterBuilder.Or(f1);
        ...
        [TestMethod]
        [TestCategory("Filter")]
        public void FilterBuilder_Or_TwoArguments_Success()
        {
            Expression<Func<Person, bool>> f1 = (x) => x.Id > 0;
            Expression<Func<Person, bool>> f2 = (x) => x.Category == "CATEGORY 1";
            Expression<Func<Person, bool>> mergedExpression = FilterBuilder.Or(f1, f2);
        ...
        [TestMethod]
        [TestCategory("Filter")]
        public void FilterBuilder_Or_ThreeArguments_Success()
        {
            Expression<Func<Person, bool>> f1 = (x) => x.Id > 0;
            Expression<Func<Person, bool>> f2 = (x) => x.Category == "CATEGORY 1";
            Expression<Func<Person, bool>> f3 = (x) => x.Name == "Dude";
            Expression<Func<Person, bool>> mergedExpression = FilterBuilder.Or(f1, f2, f3);
        ...
        [TestMethod]
        [TestCategory("Filter")]
        public void FilterBuilder_Or_FourArguments_Success()
        {
            Expression<Func<Person, bool>> f1 = (x) => x.Id > 0;
            Expression<Func<Person, bool>> f2 = (x) => x.Category == "CATEGORY 1";
            Expression<Func<Person, bool>> f3 = (x) => x.Name == "Dude";
            Expression<Func<Person, bool>> f4 = (x) => x.City == "LA";
            Expression<Func<Person, bool>> mergedExpression = FilterBuilder.Or(f1, f2, f3, f4);
        ...
        [TestMethod]
        [TestCategory("Filter")]
        public void FilterBuilder_Or_FiveArguments_Success()
        {
            Expression<Func<Person, bool>> f1 = (x) => x.Id > 0;
            Expression<Func<Person, bool>> f2 = (x) => x.Category == "CATEGORY 1";
            Expression<Func<Person, bool>> f3 = (x) => x.Name == "Dude";
            Expression<Func<Person, bool>> f4 = (x) => x.City == "LA";
            Expression<Func<Person, bool>> f5 = (x) => x.IsGolfer == true;
            Expression<Func<Person, bool>> mergedExpression = FilterBuilder.Or(f1, f2, f3, f4, f5);
